...
class Member_landing(customtkinter.CTkFrame):
    def __init__(self, master=None, username=None):
        ...
        self.welcome.pack(side='left', padx=20, pady=50)

        # Create a frame to display the list of listeners
        self.dispframe = customtkinter.CTkFrame(master=self.inner_frame, width=200, height=400, bg_color='white')
        self.dispframe.pack(padx=20, pady=20)
